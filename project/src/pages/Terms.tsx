      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <p className="text-gray-700">
            These Terms of Service govern your use of LoanPro's website and services.
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mt-8">
          ...
          <p className="text-gray-700 mb-6">
            LoanPro shall not be liable for any indirect, incidental, special, consequential,
          ...
          <p className="text-gray-700 mb-6">
            ...
            services if we believe you have violated these Terms or engaged in any
          ...
          <p className="text-gray-700 mb-6">
            ...
            use of the services after changes take effect constitutes your acceptance.
          </p>
          ...
          <ul className="text-gray-700 space-y-2">
            ...
            <li className="flex items-center">
              <Phone className="h-5 w-5 text-blue-600 mr-2" /> +1 (800) 555-1234
            </li>
          </ul>
        </div>
      </div>
