...
import { calculateEMI, getLoanPurposes, getInterestRate } from '../../utils/loanCalculator';
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">
                          ${(emi * parseInt(formData.duration || '0')).toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Total Interest:</span>
                        <span className="font-semibold text-orange-600">
                          ${(emi * parseInt(formData.duration || '0') - parseFloat(formData.amount || '0')).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
