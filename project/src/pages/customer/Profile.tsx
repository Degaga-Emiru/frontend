...
import {  User, Calendar, Shield, Bell, DollarSign, Clock,
   Lock,  History
} from 'lucide-react';
...
const Profile: React.FC = () => {
  ...
  const mockLoans = [
    { id: 1, amount: 5000, interestRate: 5.5, status: 'active', nextPayment: '2024-01-15' },
    { id: 2, amount: 10000, interestRate: 7.2, status: 'pending', nextPayment: null }
  ];
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    {mockLoans.filter(loan => loan.status === 'active').length > 0 ? (
                      <div className="space-y-3">
                        {mockLoans.filter(loan => loan.status === 'active').map(loan => (
                          <div key={loan.id} className="border rounded-lg p-3 bg-white">
                            <div className="flex justify-between items-start">
                              <div>
                                <p className="font-medium">${loan.amount.toLocaleString()}</p>
                                <p className="text-sm text-gray-600">{loan.interestRate}% interest</p>
                              </div>
                            ...
                            <div className="mt-2 text-sm">
                              <p>Next payment: {formatDate(loan.nextPayment)}</p>
                            </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    {mockLoans.filter(loan => loan.status === 'pending').length > 0 ? (
                      <div className="space-y-3">
                        {mockLoans.filter(loan => loan.status === 'pending').map(loan => (
                          <div key={loan.id} className="border rounded-lg p-3 bg-white">
                            <div className="flex justify-between items-start">
                              <div>
                                <p className="font-medium">${loan.amount.toLocaleString()}</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Get notified when your loan application status changes</p>
                      </div>
