        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-blue-600 px-6 py-4">
              <h1 className="text-2xl font-bold text-white">Verify Micro-Deposit</h1>
            </div>
            ...
            <div className="p-6">
              <div className="mb-6">
                <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900">Deposit Sent!</h3>
                    <p className="text-sm text-blue-700">
                      A small deposit has been sent to your account ending in ****{accountNumber.slice(-4)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-gray-700">
                  Please check your bank statement and enter the amount of the small deposit we sent.
                  This may take 1-2 business days to appear in your account.
                </p>
                
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800">
                    <strong>Demo Mode:</strong> For testing purposes, enter 0.12 as the amount.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8 text-white">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1">Secure verification required to apply for loans</p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Your account information is encrypted and protected using industry-standard security
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700">Enter your bank account number below</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold">
                      2
                    </div>
                    <p className="text-gray-700">We'll send a small deposit (less than $1.00) to your account</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold">
                      3
                    </div>
                    <p className="text-gray-700">Verify the deposit amount to confirm account ownership</p>
                  </div>
                </div>
              </div>
            </div>
