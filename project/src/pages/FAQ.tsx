...
import { ChevronDown, ChevronUp, HelpCircle, BookOpen, FileText, CreditCard } from 'lucide-react';
      ...
      questions: [
        {
          ...
          a: 'Loan amounts vary by type: Personal loans up to $50,000, Auto loans up to $100,000, and Mortgage loans up to $1,000,000.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: 'You can reach us at 1-800-LOAN-PRO, by email at support@loanpro.com, or through our live chat service.'
        },
        {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Find answers to common questions about our loan services and processes.
          </p>
        </div>
