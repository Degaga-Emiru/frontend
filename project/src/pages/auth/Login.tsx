            ...
            <div>
              ...
              <div className="flex rounded-md shadow-sm">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-l-md border border-gray-300 text-sm font-medium ${
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-r-md border border-gray-300 text-sm font-medium ${
                    formData.role === 'admin'
                      ? 'bg-blue-600 text-white border-blue-600'
                      : 'bg-white text-gray-700 hover:bg-gray-50'
                  }`}
